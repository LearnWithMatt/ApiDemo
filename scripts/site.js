...
function processAllMemes(memes){
    ...
    for(let currentRowIndex = 0 ; currentRowIndex < numberOfRows; currentRowIndex++){
        let currentRow = document.createElement("div");
        currentRow.className = "row";

        imglistsection.appendChild(currentRow);
    ...
    function getArrayForSingleRow(arrayWithAllMemes, nextMemeIndex, columnsPerRow){
        let result = arrayWithAllMemes.slice(nextMemeIndex, nextMemeIndex + columnsPerRow);
        return result;
    }
